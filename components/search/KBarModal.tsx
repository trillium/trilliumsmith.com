...
export const KBarModal = ({ actions, isLoading }: KBarModalProps) => {
        ...
        <KBarAnimator className="w-full max-w-xl">
          <div className="overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
            <div className="flex items-center space-x-4 p-4">
              ...
              <kbd className="inline-block whitespace-nowrap rounded border px-1.5 align-middle text-xs font-medium leading-4 tracking-wide text-gray-400 border-gray-400">
                ESC
              </kbd>
            </div>
