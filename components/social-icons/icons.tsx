...
export function Github(svgProps: SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    >
      ...
      />
      {/* Left ear — flattens on hover (airplane ears) */}
      <path
        fill="currentColor"
        d="M7.5 1 L8.5 -0.8 L9.5 1 Z"
        style={{ transformBox: 'fill-box', transformOrigin: '50% 100%' }}
        className="group-hover:animate-ear-left group-focus:animate-ear-left"
      />
      {/* Right ear — flattens on hover (airplane ears) */}
      <path
        fill="currentColor"
        d="M14.5 1 L15.5 -0.8 L16.5 1 Z"
        style={{ transformBox: 'fill-box', transformOrigin: '50% 100%' }}
        className="group-hover:animate-ear-right group-focus:animate-ear-right"
      />
    </svg>
  )
}
...
export function Twitch(svgProps: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...svgProps}>
      <title>Twitch</title>
