...
The implementation isn't really the thing I wanted to highlight. The fact that this worked is. The [Beads Bridge MCP server](https://github.com/trillium/beads-bridge) fronts my local Beads store.
